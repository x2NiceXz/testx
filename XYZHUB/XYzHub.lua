local NameofHub = 'XYz hub'
local NameofHub2 = 'XYz hub'
...
Tab1:CreateToggle("AutoFarmLevel",_G.FarmLevel,function(d)
_G.FarmLevel = d
_G.Gaviteop = d
...
Tab44:CreateToggle("Part Rainbow",nil,function(Value)
    _G.PART = true
end)
